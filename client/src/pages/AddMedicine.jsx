            ...
            <AppBar style={{ height: "100%", backgroundColor: "#F0F0F0", overflowY: "auto", }}>
                ...
                <div style={{ backgroundColor: "rgb(0,140,990)", borderRadius: '50px', margin: '10px', width: '30%', marginLeft: '35%' }}>
                    <h1 style={{ font: "Arial", fontWeight: 'bold', color: "white", margin: "10px" }}>
                        <AddCircleIcon fontSize='large' sx={{ color: "white", marginRight: '20px' }} />
                        Add Medicine </h1>
                </div>
                {showAlert && (
                    <Alert style={{ marginTop: '2%', fontSize: '18px', backgroundColor: ' RGB(50, 205, 50)', width: '70%', marginLeft: '15%' }} variant="filled" severity="success" onClose={() => setShowAlert(false)} dismissible>
                    ...
                    <div className="card-body" style={{}}>
                        ...
                        <form action="" onSubmit={handleSubmit} >
                            ...
                            <button onClick={handleButtonClick}
                                style={{ backgroundColor: 'rgb(0,140,990)', width: '10%', borderRadius: "20px" }} type="submit" className="btn btn-success" >
                                Add
